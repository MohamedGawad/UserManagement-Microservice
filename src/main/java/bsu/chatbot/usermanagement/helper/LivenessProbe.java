...
package bsu.chatbot.usermanagement.helper;
...
import bsu.chatbot.usermanagement.controller.UserProfileController;
...
public class LivenessProbe implements HealthCheck {
	...
	public HealthCheckResponse call() {
		...
		try {
			...
			if (UserProfileController.isHealthy()) {
				builder = builder.up();
			...
			builder = builder.withData("consecutiveErrors", UserProfileController.consecutiveErrors);
